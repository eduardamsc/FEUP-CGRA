...
function MyTorpedo(scene, target) {
	...
	//controlar posicao
	this.xPosition = this.scene.submarine.xPosition;
	this.yPosition = this.scene.submarine.yPosition;
	this.zPosition = this.scene.submarine.zPosition;
	...
	//controlar rotação
	this.rotAngle = this.scene.submarine.rotAngle;
	this.rotYAngle = this.scene.submarine.rotYAngle;
